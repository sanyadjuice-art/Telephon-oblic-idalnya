...
async def parse_pdf(file: UploadFile = File(...)):
    try:
        ...
        # Використовуємо класичний pdfplumber.open із загорнутим потоком байтів
    ...
    try:
        # Читаємо байти безпосередньо у змінну pdf_bytes
        pdf_bytes = await file.read()
    ...
    try:
        ...
        if not contents or len(contents) < 100:
            return JSONResponse(content={"error": "Отримано порожній або пошкоджений файл"}, status_code=400)
